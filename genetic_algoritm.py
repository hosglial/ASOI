# 6. Описать функционирование одной эпохи генетического алгоритма на
...
# Использовать следующие параметры генетического алгоритма: фитнессфункция – сумма всех бит,
# деленная на количество бит в особи; метод отбора –
# рулетка с использованием принципа элитизма; оператор скрещивания –
